...
FINAL_IMAGE=${DISTDIR}/Blink_LED_GP1_ASM_10F200.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=blinkGP1main.as

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/blinkGP1main.o
POSSIBLE_DEPFILES=${OBJECTDIR}/blinkGP1main.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/blinkGP1main.o

# Source Files
SOURCEFILES=blinkGP1main.as
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Blink_LED_GP1_ASM_10F200.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC10F200
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/Blink_LED_GP1_ASM_10F200.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/blinkGP1main.o: blinkGP1main.as  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/blinkGP1main.o 
	${MP_AS} -mcpu=PIC10F200 -c \
	-o ${OBJECTDIR}/blinkGP1main.o \
	blinkGP1main.as \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/Blink_LED_GP1_ASM_10F200.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC10F200 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/Blink_LED_GP1_ASM_10F200.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
